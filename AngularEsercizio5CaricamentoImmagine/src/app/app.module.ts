...
import { ArbitriConfermaDesignazioneDialogComponent } from './Components/arbitri-conferma-designazione-dialog/arbitri-conferma-designazione-dialog.component';
...
@NgModule({
  declarations: [
    ...
    ArbitriConfermaDesignazioneDialogComponent
